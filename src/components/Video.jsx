  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col">
        ...
        <div className="relative h-38 md:h-56 md: rounded-xl hover:rounded-none duration-200 overflow-hidden">
       ...
       <div className="flex items-start">
        ...
        <div>
          ...
          <span className="flex items-center font-semibold mt-2 text-[12px] text-gray-600">{video?.author?.title}{video?.author?.badges[0]?.type==="VERIFIED_CHANNEL" && (<BsCheckCircleFill className="text-gray-600 ml-1 text-[12px]" />)}</span>
